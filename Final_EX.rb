class Dictionary
  ...
  ####### Dont use global variables inside classes, use 'intialize' function and intialise these as variables
  ...
  def process
    ...
    ## Use puts instead of print and new line character - does the same job
